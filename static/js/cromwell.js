...
var data = [
  {
    className: 'specific',
    axes: [
      { axis: "Firepower", value: 250 },
      { axis: "Survivability", value: 72 },
      { axis: "Mobility", value: 719 },
      { axis: "Concealment", value: 320 },
      { axis: "Spotting", value: 502 }
    ]
  },
  {
    className: 'average',
    axes: [
      { axis: "Firepower", value: 124 },
      { axis: "Survivability", value: 73 },
      { axis: "Mobility", value: 596 },
      { axis: "Concealment", value: 240 },
      { axis: "Spotting", value: 473 }
    ]
  }
];
...
svg.append("text").attr("x", 60).attr("y", cfg.h + 20).text("Cromwell").style("font-size", "15px").attr("alignment-baseline", "middle")
svg.append("text").attr("x", 60).attr("y", cfg.h + 50).text("Average for mediums tanks in tier VI").style("font-size", "15px").attr("alignment-baseline", "middle")
