...
var data = [
    ...
    className: 'specific',
    axes: [
        {axis: "Firepower", value: 730}, 
        {axis: "Survivability", value: 180}, 
        {axis: "Mobility", value: 732},  
        {axis: "Concealment", value: 272},  
...
svg.append("text").attr("x", 60).attr("y", cfg.h + 20).text("Progetto m40 mod 65").style("font-size", "15px").attr("alignment-baseline","middle")
